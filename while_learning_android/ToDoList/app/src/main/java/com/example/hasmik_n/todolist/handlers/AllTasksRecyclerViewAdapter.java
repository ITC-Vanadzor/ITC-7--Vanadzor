...
public class AllTasksRecyclerViewAdapter extends RecyclerView.Adapter<AllTasksRecyclerViewAdapter.ViewHolder> {
    private List<Task> taskList;
    private List<Task> finishedTaskList;

    public AllTasksRecyclerViewAdapter(List<Task> tasks) {
        this.taskList = tasks;
    }

    @Override
    public AllTasksRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
